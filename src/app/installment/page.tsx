...
export default function InstallmentPage() {
  ...
  return (
    <main className="flex-1 w-full flex flex-col items-center">
        ...
        <div className="w-full max-w-screen-xl mx-auto relative z-10 text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a 
              ...
              className="px-8 py-4 bg-primary hover:bg-primary/90 text-white rounded-xl font-bold flex items-center justify-center gap-2 transition-all shadow-[0_0_20px_rgba(37,99,235,0.3)] hover:shadow-[0_0_30px_rgba(37,99,235,0.5)] w-full sm:w-auto"
            >
      ...
      {/* Benefits Section */}
      <section className="w-full py-20 px-6 bg-background relative border-y border-white/5">
        <div className="w-full max-w-screen-xl mx-auto">
          <div className="text-center mb-16">
            <h2 className="text-3xl md:text-4xl font-bold text-white mb-4">Наши преимущества</h2>
            <p className="text-white/60 max-w-2xl mx-auto">Сотрудничаем с ведущими банками для предоставления лучших условий финансирования.</p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            {benefits.map((benefit, index) => (
              <div 
                key={index}
                className="bg-card border border-white/10 rounded-2xl p-8 hover:bg-white/5 transition-colors relative overflow-hidden group"
              >
        ...
        <div className="w-full max-w-screen-xl mx-auto">
          <div className="flex flex-col lg:flex-row gap-16 items-center">
            <div className="w-full lg:w-1/3">
              <h2 className="text-3xl md:text-4xl font-bold text-white mb-6">Как оформить<br />рассрочку?</h2>
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="px-6 py-3 bg-white/10 hover:bg-white/20 text-white border border-white/20 rounded-xl font-semibold inline-flex items-center gap-2 transition-all"
              >
            ...
            <div className="w-full lg:w-2/3 grid grid-cols-1 sm:grid-cols-2 gap-6">
              {steps.map((step, index) => (
                <div key={index} className="bg-background border border-white/5 rounded-2xl p-8 relative">
                  <span className="absolute -top-4 -right-4 text-7xl font-black text-white/5 z-0">
                    {step.number}
                  </span>
      ...
      {/* CTA */}
      <section className="w-full py-24 px-6 bg-gradient-to-br from-primary/20 via-background to-background relative border-t border-white/10">
        <div className="w-full max-w-4xl mx-auto text-center bg-card border border-white/10 rounded-3xl p-10 md:p-16 shadow-2xl relative overflow-hidden">
          <div className="absolute top-0 right-0 w-64 h-64 bg-primary/20 rounded-full blur-[80px] -mr-32 -mt-32" />
          <div className="absolute bottom-0 left-0 w-64 h-64 bg-blue-500/20 rounded-full blur-[80px] -ml-32 -mb-32" />
          
          <h2 className="text-3xl md:text-4xl font-bold text-white mb-6 relative z-10">Остались вопросы?</h2>
          ...
          <div className="flex justify-center gap-4 relative z-10">
            <a 
              ...
              target="_blank"
              rel="noopener noreferrer"
              className="px-8 py-4 bg-[#0088cc] hover:bg-[#0088cc]/90 text-white rounded-xl font-bold flex items-center gap-2 transition-all shadow-[0_0_20px_rgba(0,136,204,0.3)] hover:scale-105"
            >
              <Send className="w-5 h-5" />
              Написать в Telegram
            </a>
